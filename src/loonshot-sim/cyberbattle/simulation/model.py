...
class NodeInfo:
    ...
    last_reimaging: Optional[datetime.datetime] = None
...
class Environment(NamedTuple):
    ...
    creationTime: datetime.datetime = datetime.datetime.utcnow()
    lastModified: datetime.datetime = datetime.datetime.utcnow()
