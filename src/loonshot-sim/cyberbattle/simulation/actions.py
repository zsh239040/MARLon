...
class AgentActions:
    ...
    def __mark_node_as_owned(self,
                             ...
                             privilege: PrivilegeLevel = model.PrivilegeLevel.LocalUser) -> Tuple[Optional[datetime.datetime], bool]:
        """Mark a node as owned.
        Return the time it was previously owned (or None) and whether it was already owned."""
    ...
    def __process_outcome(self,
        ...
        # Note: discovered_nodes_value should not be added unless the nodes get owned (handled above)
