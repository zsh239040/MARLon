...
EVALUATE_EPISODES = 5
ATTACKER_MODEL_FILENAME = "a2c_marl_attacker.zip"
DEFENDER_MODEL_FILENAME = "a2c_marl_defender.zip"
RUN_NAME = "a2c_marl"
...
def train(evaluate_after: bool = False, run_dir: Optional[RunDir] = None, also_print: bool = True) -> Path:
    ...
    with log_run(RUN_NAME, "train", hyperparams, run_dir=run_dir, base_dir=base_dir, also_print=also_print) as (run_path, _):
        ...
        print(f"Training A2C attacker and defender. Run directory: {run_path}")
        ...
        if evaluate_after:
            from marlon.baseline_models.a2c import eval_marl
